...
class EMGAugment(nn.Module):
    ...
    def __init__(
        ...
        p_noise=0.5,
        noise_rms_frac=0.03,   # noise std = frac * per-sample RMS  (0.03..0.10)

        # gain (log-normal)
        p_gain=0.5,
        gain_log_std=0.08,     # multiplicative factor ~ exp(N(0, log_std)) (0.05..0.20)
